...
export function useNavClick(drawer = null, iconAction = null) {
  ...
  const navList = [
    ...
    },
    {
      ...
      fullName: 'YuleChat',
      icon: ChatDotSquare,
      img: 'https://i.pixiv.re/img-original/img/2022/11/20/11/59/06/102944326_p0.jpg',
      action: 'goChat'
    },
    {
      text: '插画',
      fullName: 'Yule插画',
      icon: PictureFilled,
      img: 'https://i.pixiv.re/img-original/img/2025/07/31/15/17/02/133318656_p0.jpg',
      action: 'goComics',
    },
     {
      text: '动漫',
      ...
      img: 'https://i.pixiv.re/img-original/img/2025/09/07/00/13/43/134795768_p0.jpg',
      action: 'goVideo',
    },
    {
      text: '漫画',
      fullName: 'Yule漫画',
      icon: Collection,
      img: 'https://i.pixiv.re/img-original/img/2025/04/27/18/00/27/129760572_p0.jpg',
      action: 'goPica',
      role: 999,
    },
    {
      ...
      fullName: 'Yule小说',
      icon: Management,
      img: 'https://i.pixiv.re/novel-cover-master/img/2026/01/01/00/49/54/sci15170940_ee5a5a92e96bf0d4ce9f84bf74d2814c_master1200.jpg',
      action: 'goNovel',
    },
